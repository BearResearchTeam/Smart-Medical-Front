  ...
  <div class="app-container">
    ...
    <el-card shadow="hover" class="data-table">
      ...
      <el-table v-loading="loading" :data="deptList" row-key="id" default-expand-all
        :tree-props="{ children: 'children', hasChildren: 'hasChildren' }" class="data-table__content"
        @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55" align="center" />
        <el-table-column type="index" label="序号" min-width="200" />
        <el-table-column prop="code" label="科室名称" width="200" />
        <el-table-column prop="code" label="科室大类" width="200" />
        <el-table-column prop="code" label="地址" width="200" />
        <el-table-column prop="code" label="负责人名称" width="200" />
        <el-table-column prop="code" label="医师人数" width="200" />
        <el-table-column prop="code" label="药师人数" width="200" />
        <el-table-column prop="code" label="护士人数" width="200" />
...
import DeptAPI, { DeptForm, DeptQuery } from "@/api/system/dept.api";
